...
class Thresholding:
    ...
    def forward(self, img, lane=2, image=False, debug=False):
        ...
        # adaptive_thresh = cv2.adaptiveThreshold(blurred, 255, cv2.ADAPTIVE_THRESH_GAUSSIAN_C, cv2.THRESH_BINARY, blockSize, C)
...
class LaneLines:
    ...
    def find_lane_pixels(self, img, lane=2, image=False, debug=False):
        ...
        # 寻找右线
            ...
            for i in range(self.n_windows):
                ...
                if len(good_right_x) > self.min_pix:
                    ...
                    print(f"当前第{i}个窗口有{good_right_x}个车道线点")
        ...
        # 两条线都寻找
            ...
            return left_x, left_y, right_x, right_y,left_ang,right_ang
    ...
    def fit_poly(self, img, image=False, debug=False):
        ...
        # 确定边线
        left_x, left_y, right_x, right_y, left_ang, right_ang = self.find_lane_pixels(img, lane=2, image=image, debug=debug)
        ...
        # 到达左转第一标志位
        if left_ang >= 1 and right_ang == 0 and right_angle_1 == 0:
            turn_left = 1
            right_angle_1 = 1 
            print("到达左转第一标志位")

        # 到达右转第一标志位
        elif left_ang == 0 and right_ang >= 1 and right_angle_1 == 0:
            turn_left = 0
            right_angle_1 = 1 
            print("到达右转第一标志位")
